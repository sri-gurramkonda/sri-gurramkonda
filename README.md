...
# Hello World 👋 I'm Sri Venkat Gurramkonda
...
### 🛒 Retail Shelf Product Detection using YOLOv5
- Deep Learning based retail object detection system
- YOLOv5 + PyTorch + OpenCV
- Custom dataset with multiple retail products

### 🎓 International Student Survival RAG
- Retrieval-Augmented Generation system
- FAISS + LLMs + NLP
- Student guidance AI assistant

### 👁️ Blind But a Trained Hunter
- AI agent using Hidden Markov Models
- A* Search + probabilistic reasoning
